...
for v in data:
    ...
    run('make quay/retag QUAY_RETAG_NAME={} COMPONENT_NAME={} QUAY_COMPONENT_TAG={} QUAY_DRY_RUN={}'.format(retag_name,component_name,compenent_tag,sys.argv[3]), shell=True)