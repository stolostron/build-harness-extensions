...
postgres_spec_13=registry.redhat.io/rhel8/postgresql-13@sha256:d8ec037e60575b86320fdc162117600240ce53038fb8b9b7296ce525d2b8e605
...
make_index () {
	...
	if [[ -z $PIPELINE_MANIFEST_MIRROR_BONUS_TAG ]]; then
		...
		echo docker pull quay.io/acm-d/$INDEX:$PIPELINE_MANFIEST_INDEX_IMAGE_TAG
		docker pull quay.io/acm-d/$INDEX:$PIPELINE_MANFIEST_INDEX_IMAGE_TAG
		...
		echo docker push quay.io/acm-d/$INDEX:$PIPELINE_MANIFEST_MIRROR_BONUS_TAG
...
if [[ -z $SKIP_INDEX ]]; then
  ...
  echo $postgres_spec_12=__DESTINATION_ORG__/postgresql-12:$Z_RELEASE_VERSION-DOWNSTREAM-$DATESTAMP >> mapping.txt
  echo $postgres_spec_13=__DESTINATION_ORG__/postgresql-13:$Z_RELEASE_VERSION-DOWNSTREAM-$DATESTAMP >> mapping.txt
